...
public class ShoppingController extends HttpServlet {
    ...
    private final String MANAGE_PAGE = "shopping.jsp";
    private final String HOME_PAGE = "mainPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> list = dao.loadAllProductList(Integer.parseInt(index));
            if (list != null) {
